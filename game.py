...
class Game:
    ...
    def setup(self):
        ...
        hall.exits = {"N" : parloire, "E" : infirmerie, "S" : escaliersB, "O" : cuisine, "Up" : None, "Down" : None}
